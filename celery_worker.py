...
def setup_periodic_tasks(sender, **kwargs):
    ...
    sender.add_periodic_task(60.0, log.s(('The time is now: {}'.format(time_now.strftime('%c')))), name='Log date time every minute')
    ...
    sender.add_periodic_task(14400.0, log.s(("The time is now: {}".format(time_now.strftime("%c")))), name="Log date time every 4 hours")
    # periodic task to execute every 6 hours (21600)
    # periodic tasks executes every 8 hours (28800)
    sender.add_periodic_task(28800.0, log.s(("The time is now: {}".format(time_now.strftime("%c")))), name="Log date time every 8 hours")
    ...
    sender.add_periodic_task(
        ...
        log.s(("The time is now: {}".format(time_now.strftime("%c"))), name="Log every 2 minutes after midnight"),
